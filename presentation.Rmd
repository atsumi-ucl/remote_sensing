...
- Aims 
> Data consistent with data from the earlier Landsat missions and 
> Distribution of Landsat data products to the public
...
# Reflection
- Lots of modelling/transformation needed to derive the information required for various purposes
> eg earth surface temperature or urban built-up areas
