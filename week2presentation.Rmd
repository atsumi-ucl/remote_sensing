...
# Two sensors of Landsat-9
## Operational Land Imager (OLI)

-   Multispectral  sensor including: visible, near infrared and shortwave infrared portions (Band 1 through Band 9)

-   Additional bands for water and clouds detection

-   Collection of land-surface data

-   Spatial resolution = 15m x 15m (panchromatic) and 30m x 30m (multispectral)
