...
There are global policy and targets but when it comes to heat action plans, local policies are important because heat exposure is quite different depending on various local factors including local geometry, plans, housing materials (which may be related to socio-economic status of individuals): they may exacerbate or mitigate one's exposure to heat. Local government authorities are well positioned to address these local issues. So to make adaptation plans, I think it is important to look at local policies and work with local governments. I would have not read local policies,had I not taken this module, and I am glad I had the opportunity to read a local policy example.
