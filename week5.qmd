...
```{javascript}
var tzadar = ee.FeatureCollection('projects/casa0023week5/assets/gadm41_TZA_1')
    .filter('GID_1 == "TZA.2_1"');
var bounds = tzadar.geometry();


Export.image.toDrive({
  image: rf2,
  description: 'TZN informal settlements',
  scale:10,
  crs: 'EPSG:21096',
  maxPixels: 100E10,
  region: bounds
